...
export default function GovtHeader({ fontSize, setFontSize, isHighContrast, setIsHighContrast, language, setLanguage }) {
  return (
    <header style={{ background: '#ffffff', borderBottom: '1px solid #e2e8f0' }}>
      ...
      <div className="ux4g-container" style={{ padding: '12px 16px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '12px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', flex: 1, minWidth: '240px' }}>
          {/* Ashoka Stambha SVG Emblem */}
          <svg width="36" height="58" viewBox="0 0 50 80" fill="none" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Government Emblem">
          ...
          <div>
            <h1 style={{ margin: 0, fontSize: '1.15rem', color: '#0A3161', fontWeight: 700, letterSpacing: '-0.2px', lineHeight: 1.25 }}>
              {language === 'hi' ? 'राष्ट्रीय साइबर अपराध रिपोर्टिंग पोर्टल' : 'National Cyber Crime Reporting Portal'}
            </h1>
            <div style={{ fontSize: '0.8rem', color: '#596168', marginTop: '2px' }}>
        ...
        <a href="tel:1930" className="ux4g-desktop-helpline" style={{ textDecoration: 'none', color: 'inherit' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px', background: '#fce8e6', border: '1px solid #f5c6cb', padding: '8px 16px', borderRadius: '30px', minHeight: '44px' }}>
            ...
            <div>
              <div style={{ fontSize: '0.68rem', color: '#721c24', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.3px' }}>
